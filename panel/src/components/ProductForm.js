...
function ProductForm({ initialValues = {}, method, url }) {
   return <div className="container m-auto">
      <DataPoster method={method} url={url}>
            ...
            return <Form
               ...
               render={({ handleSubmit, values, form: { reset, mutators: { update } } }) => {
                  ...
                  return <form onSubmit={handleSubmit}>
                     ...
                     <div className="shadow-lg p-4 mt-4 rounded-lg">
                        <div className="card-header">
                           <h2 className="text-xl font-bold font-weight-400">ثبت محصول جدید</h2>
                        </div>
                        <div className="card-body">
                           <div className="flex">
                              <Field
                                 validate={composeValidators([required('نام محصول اجباری میباشد'),
                                 isAvaible({
                                    url: endpoints.products.get,
                                    defaultText: initialValues.name,
                              ...
                              <Field
                                 ...
                                 label="پدر"
                                 labelField='name'
                                 initialSelectedItem={(initialValues || {}).categorySelected}
                                 onChange={(v) => {
                                    console.log(v)
